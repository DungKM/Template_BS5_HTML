<!-- <?php
   ...
   $db_name = "mysql:host=localhost;dbname=duan";
   $username = "root";
   $password = "";
...
<body>
   ...
   ?>
                            <li><a href="#"><?= $fetch_categorys['name_ct']; ?></a></li>
                            <?php
         }
      }else{
   ...
   ?>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="uploaded_img/<?= $fetch_categorys['img']; ?>">
                            <h5><a href="#"><?= $fetch_categorys['name_ct']; ?></a></h5>
                        </div>
                    </div>
                    <?php
         }
         ...
         ?> -->
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="uploaded_img/<?= $fetch_products['image'] ?>">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?= $fetch_products['name'] ?></a></h6>
